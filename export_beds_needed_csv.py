...
Columns: county, state, current_ob_beds, beds_required_for_low_risk, already_low_risk,
         pct_counties_not_low_risk (value only in row 1)
...
def main():
    ...
    for _, row in df.iterrows():
        ...
        res = beds_needed_for_low_risk(prenatal, births, ob_beds)
